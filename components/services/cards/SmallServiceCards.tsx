...
const SmallServiceCards: React.FC<Props> = ({ ServiceData }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#0D101E] to-[#5E8DA2] h-[18rem] shadow-lg rounded-lg flex flex-col w-full p-[1rem] hover:shadow-lg hover:shadow-[#0D101E] min-w-[18rem] max-w-[25rem]">
